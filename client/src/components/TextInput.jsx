...
const Textinput = (props) => {
    return (
        <input
            data-testid={
                props['data-testid'] ? props['data-testid'] : 'qa-text-input'
            }
            type="text"
            name={props.name}
            className={
