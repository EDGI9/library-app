...
const Book = (props) => (
    <div className="flex flex-col items-center gap-3">
      <div className="max-w-[200px] max-h-[500px]">
        {/* Link to book details page `/edit/${props.book._id}` */}
        <img src="https://as1.ftcdn.net/v2/jpg/05/04/28/96/1000_F_504289605_zehJiK0tCuZLP2MdfFBpcJdOVxKLnXg1.jpg" alt="" width={200} height={500} />
      </div>
